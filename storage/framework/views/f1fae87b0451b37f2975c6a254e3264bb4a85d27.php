            ...
            <div class="row ">
                <div class="col-lg-12">
                    <div class="card card-info">
                        ...
                        <?php endif; ?>
                        <form class="card-body" style="margin: 10px" action="<?php echo e(route('payment-requests.update', $invoice->id)); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" class="form-control" id="discount_percentage" name="discount_percentage" placeholder="Enter discount percentage" min="0" max="100" value="<?php echo e($invoice->discount_percentage); ?>" oninput="calculateTotal()">
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\git\quickBook_panelone\resources\views/payment-requests/edit-invoice.blade.php ENDPATH**/ ?>